...
整数数列のオンライン百科事典 OEIS（On-Line Encyclopedia of Integer Sequences）[cite:sloane1996] は、2026年3月時点で組合せ論・数論・代数学など数学の幅広い分野にまたがる 370,000 件以上の数列エントリを収録した事実上の標準リファレンスである。

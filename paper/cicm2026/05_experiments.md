...
|----------------|--------:|---------:|---------:|
| Small ($v<1$)          | **0.111** | 0.138  | 0.103    |
| Medium ($1\le v<3$)    | **0.051** | 0.071  | 0.116    |
| Large ($3\le v<6$)     | **0.162** | 2.100  | 0.381    |
| Huge ($6\le v<10$)     | **2.082** | 22.73  | 5.021    |
| Astronomical ($v\ge10$) | **110.4** | 840.0 | 532.6    |
...
**モード別内訳（Large IntSeqBERT）。** Solver は 4 つの再構成モードから選択する：

| モード | 使用率  | Top-1 | 説明                              |
|--------|--------:|------:|-----------------------------------|
| dense  | 24.0%   | 61.06 | 実数値探索による直接列挙           |

...
terms and those carrying any of eleven OEIS tags incompatible with integer-sequence prediction
(\texttt{cons}/\texttt{cofr}/\texttt{frac}/\texttt{base}/\texttt{word} for out-of-scope
representations; \texttt{fini}/\texttt{tabl} for undefined task; \texttt{dead}/\texttt{unkn}/\texttt{less}/\texttt{dumb}
for quality), yielding 274,705 sequences (70.1\%) as our standard dataset (\texttt{std}).

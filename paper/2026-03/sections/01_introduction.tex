...
% 2026年1月時点で組合せ論・数論・代数学など数学の幅広い分野にまたがる 391,710 件の数列エントリを
% 収録した事実上の標準リファレンスである。
...
% 数値パターンの観察が予想の端緒となってきた歴史を踏まえ、異分野の数列間に潜む数論的類似性を
% 発見し予想生成を支援する AI システムの構築が長期目標。本論文はその第一歩として、
% Modulo スペクトル表現が数論的構造をどの程度捉えられるかを穴埋めタスクで検証する。
...
% Kaggle 型の数列予測タスクとの違い（貢献は精度そのものではなく表現の提案と定量的証拠）。
